...
describe('AlertSnackbar', () => {
  it('should render loading AlertSnackbar', () => {
    ...
    expect(screen.getByText(AlertSnackbarLoading.args?.message as string)).toBeInTheDocument();
  });
  it('should render success AlertSnackbar', () => {
    render(<AlertSnackbarSuccess />);

    expect(screen.getByText(AlertSnackbarSuccess.args?.message as string)).toBeInTheDocument();
  });
  it('should render error AlertSnackbar', () => {
    render(<AlertSnackbarError />);

    expect(screen.getByText(AlertSnackbarError.args?.message as string)).toBeInTheDocument();
  });
});